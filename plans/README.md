...
| Retest QA fixes | [`lime/retest-qa-fixes.md`](./lime/retest-qa-fixes.md) | `lime-retest-qa-fixes`, forked from `main` (`a0baef8`; in progress) | Not a fit: the tester's retest of the three Lime QA batches against the current build, plus the layout-3 reports JP-043 … JP-047 never handed over before — JP-049's warning, JP-045's canvas Tickets →, JP-044's clipped titles, JP-046's bundle line, JP-048's Featured tick, JP-054's layout-4 boxes, JP-043's sticky column and JP-038's `padX` (last, it moves every digest); JP-047 reply only. One entry per session, plus the sweep. |
